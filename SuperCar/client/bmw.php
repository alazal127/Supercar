...
<img src="images/DV.jpeg" alt="une image " class="image-pleine-largeur">
    </div>
...
$sql = "SELECT * FROM voiture WHERE marque='BMW'";
...
while ($row = mysqli_fetch_assoc($curseur)) {
    ...
    $image = $row["image"]; // Assurez-vous que la colonne "image" existe dans la BDD
