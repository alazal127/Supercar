...
<head>
    ...
    <link href="lamborg.css" rel="stylesheet">
</head>
<body>
<header class="header">
        <div class="logo">
...
<img src="images/DV Lab.jpeg" alt="une image " class="image-pleine-largeur">  
...
<?php
include ("bdco.php");
$sql = "SELECT * FROM voiture WHERE marque='LAMBORGHINI'";
